    ...
    return (
        <div className='lg:mx-14 md:mx-8 mx-5 mb-20 mt-5'>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3  gap-4 items-center">
                ...
                <div class="mb-4 w-2/4 md:w-full mx-auto">
                    <img src="https://i.pinimg.com/originals/5e/06/d0/5e06d0dad87119043296968b650392a6.jpg" class="md:max-w-full mx-auto h-auto rounded-full border shadow-md" alt="" />
                </div>
                <div class="mb-4">
