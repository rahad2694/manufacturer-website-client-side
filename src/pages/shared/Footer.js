    ...
    return (
        <div>
            <footer className="footer p-10 bg-neutral text-white">
                <div>
                    <div className="avatar ml-4 flex-col justify-center">
                        <div className="w-16 mx-auto">
                            <Link to="/"><img alt='' src="https://i.ibb.co/9WFKHbZ/logo.png" /></Link>
                        </div>
                        <p><Link to="/" className='font-title text-3xl mb-2'>Allumin Apparatus Ltd.</Link><br />Providing reliable tools since 1992</p>
                    </div>
                </div>
                <div>
            ...
            <footer className="footer footer-center p-3 bg-base-100 text-base-content">
                <div>
                    <p>Copyright © 2022 - All right reserved by <Link className='text-orange-600 font-bold' to="/">Allumin Apparatus Ltd</Link></p>
                </div>
            </footer>
        </div>
    );
